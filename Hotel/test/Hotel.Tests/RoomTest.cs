...
namespace Hotel.Tests
{
    public class RoomTest
    {
        ...
        public void AddNewReservation_should_set_room_reserved_if_the_date_is_within_the_range()
        {
         ...
         [Fact]
        public void AddNewReservation_should_set_room_reserved_if_the_range_is_overlapped_with_the_range()
        {
            DateTime from = new DateTime(2010, 04, 09);
            ...
            bool isReserved = r.IsReserved(new DateTime(2010, 04, 11), new DateTime(2010, 04, 13));
            Assert.True(isReserved);
        }
